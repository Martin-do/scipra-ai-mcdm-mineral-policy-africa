...
- Unique extracted texts after exact SHA-256 deduplication, before manual exclusions: **301**
- Preliminary screened corpus after exact deduplication and prospective exclusions: **299**
- Acquisition exceptions: **7**
- Exact duplicate clusters / redundant records: **55 / 58**
- Same-title/year clusters still flagged: **4**
- Same-URL clusters still flagged: **5**
- Near-duplicate pairs at similarity >= 0.95: **5**
